...
export default function MeetingCard({
  ...
  return (
    ...
    >
      {hasBookCover && (
        <Link href={`/book/${meeting.book!.id}`} className="block relative">
          <img
          ...
          <div className="absolute bottom-3 left-4 right-4">
            <p className="font-sans text-[11px] uppercase tracking-widest text-cream/90 mb-1">Book Pick</p>
            <p className="font-serif text-xl text-cream leading-tight">{meeting.book!.title}</p>
          </div>
        </Link>
      )}
